...
public class ServicioCorreoBienvenida {
    ...
    public ServicioCorreoBienvenida(
            ...
            @Value("${aplicacion.correo-bienvenida.soporte}") String correoSoporte,
            @Value("${aplicacion.correo-bienvenida.url-acceso}") String urlAcceso,
        ...
        this.origenPublico = origenPublico;
    }
    ...
    public void enviar(BienvenidaEmpresaCorreo bienvenida) {
        ...
        String sitio = origenPublico + "/e/" + bienvenida.slug();
    ...
    private String texto(BienvenidaEmpresaCorreo bienvenida, String sitio) {
        return "Hola " + bienvenida.nombreAdministrador() + ",\n\n"
                ...
                + "Si tienes dudas, escríbenos a " + correoSoporte + ".\n\nEquipo Fluora";
    }
    ...
    private String html(BienvenidaEmpresaCorreo bienvenida, String sitio) {
        return """
                ...
                """.formatted(esc(bienvenida.nombreEmpresa()), esc(bienvenida.nombreAdministrador()), urlAcceso, sitio,
                        esc(correoSoporte), esc(correoSoporte));
    }
