...
import { GuardarReglaDisponibilidadPayload, OpcionNumeroDisponibilidadAdmin, OpcionTextoDisponibilidadAdmin, ReglaDisponibilidadAdmin } from '../../core/admin/admin.service';
...
export class AdminRulesSectionComponent {
  ...
  @Input({ required: true }) diasSemana!: OpcionNumeroDisponibilidadAdmin[];
  @Input({ required: true }) intervaloMinimoMinutos!: number;
